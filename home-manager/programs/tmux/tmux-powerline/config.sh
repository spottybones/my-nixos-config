...
# The theme to use.
export TMUX_POWERLINE_THEME="scott"
...
# sqlite3 -list "/var/folders/39/27stwyt15bv2ss1sxt66m_l00000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/scott/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/scott/.mailcheckrc"
# }
